    ...
    <section id="fitur" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 flex flex-col lg:flex-row items-center relative scroll-mt-20 overflow-visible">
        ...
        <div class="lg:w-1/2 w-full lg:pr-16 order-2 lg:order-1 mt-20 lg:mt-0 text-center lg:text-left relative z-10 flex flex-col items-center lg:items-start">
            ...
            <div class="relative w-full max-w-[350px] h-[450px] mx-auto lg:mx-0 mb-10 lg:mb-0">
                ...
                <!-- Node 1 -->
                <div class="absolute top-[0%] left-[20%] transform -translate-x-1/2 -translate-y-1/2 z-10 wave-icon-1">
                    ...
                    <div class="mt-2 text-center font-black text-gray-700 uppercase tracking-widest text-xs bg-white/80 rounded-full px-2 py-1 shadow-sm">Buku Sihir</div>
                </div>
                
                <!-- Node 2 -->
                <div class="absolute top-[30%] left-[80%] transform -translate-x-1/2 -translate-y-1/2 z-10 wave-icon-2">
                    ...
                    <div class="mt-2 text-center font-black text-gray-700 uppercase tracking-widest text-xs bg-white/80 rounded-full px-2 py-1 shadow-sm">Bisikan Peri</div>
                </div>
                
                <!-- Node 3 -->
                <div class="absolute top-[65%] left-[15%] transform -translate-x-1/2 -translate-y-1/2 z-10 wave-icon-3">
                    ...
                    <div class="mt-2 text-center font-black text-gray-700 uppercase tracking-widest text-xs bg-white/80 rounded-full px-2 py-1 shadow-sm">Kristal Visi</div>
                </div>
                
                <!-- Node 4 -->
                <div class="absolute top-[100%] left-[75%] transform -translate-x-1/2 -translate-y-1/2 z-10 wave-icon-4">
                    ...
                    <div class="mt-2 text-center font-black text-gray-400 uppercase tracking-widest text-xs bg-gray-100 rounded-full px-2 py-1 shadow-sm">Ujian Bos</div>
                </div>
            </div>
        </div>
